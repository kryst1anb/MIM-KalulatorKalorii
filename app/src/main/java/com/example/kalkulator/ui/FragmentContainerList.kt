...
class FragmentContainerList : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.fragment_container_list)

        val fragmentMainList = FragmentList()
        supportFragmentManager.beginTransaction().replace(R.id.fragmentContainerList,fragmentMainList).commit()
    }
